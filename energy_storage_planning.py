...
def update_master_problem_and_solve(planning_problem, master_problem_model, ess_req, dual_ess):
    ...
    for e in master_problem_model.energy_storages:
        ...
        for y in master_problem_model.years:
            ...
            master_problem_model.dual_es_s_rated[e, y].fix(dual_ess[node_id][year]['s'] / (annualization * 365.00 * num_years))
            master_problem_model.dual_es_e_rated[e, y].fix(dual_ess[node_id][year]['e'] / (annualization * 365.00 * num_years))
